...
public class AttributeController {
  ...
  @Operation(summary = "Создание атрибутов", description = "Создает атрибуты")
  @PostMapping
  ...
  @Operation(summary = "Получение атрибута", description = "Получает атрибут по его идентификатору")
  @GetMapping("/{id}")
  ...
  @Operation(summary = "Получение всех атрибутов", description = "Возвращает список всех атрибутов")
  @GetMapping
