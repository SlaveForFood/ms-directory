...
public class TierController {
    ...
    @Operation(
            summary = "Создание тиров",
            description = "Создает тир")
    @PostMapping
    public ResponseEntity<TierDto> create(
            @Valid @RequestBody TierCreateDto tierCreateDto) {
    ...
    @PutMapping
    public ResponseEntity<TierDto> update(
            @Valid @RequestBody TierUpdateDto tierUpdateDto) {
        return ResponseEntity.ok(tierService.update(tierUpdateDto));
    }

    @Operation(
            summary = "Получение тира",
            description = "Получает тир по его идентификатору")
    @GetMapping("/{id}")
    ...
    @Operation(
            summary = "Получение всех тиров",
            description = "Возвращает список всех тиров")
    @GetMapping
