...
@Tag(name = "Связи существ и атрибутов", description = "Контроллер по настройке связи существ и атрибутов")
public class  EntitiesAttributesController {
    ...
    public ResponseEntity<EntitiesAttributesDto> create(
        ...
        return ResponseEntity.status(201).body(entitiesAttributesService.create(entitiesAttributesCreateDto));
    }

    @Operation(summary = "Обновление cвязи существ и атрибутов", description = "Обновляет cвязи существ и атрибутов")
    @PutMapping
