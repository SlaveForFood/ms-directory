...
public class EntitiesAttributesServiceImpl implements EntitiesAttributesService {
  ...
  public EntitiesAttributesDto create(EntitiesAttributesCreateDto entitiesAttributesCreateDto) {
    ...
    EntitiesAttributes entitiesAttributes =
        entitiesAttributesMapper.entitiesAttributesCreateDtoToEntitiesAttributes(
            entitiesAttributesCreateDto);
    var entities =
        entitiRepo
    ...
    entitiesAttributes.setEntiti(entities);
    ...
    log.info(
        "entitiesAttributes successfully saved to the database with id: {}",
        entitiesAttributes.getId());
    EntitiesAttributesDto entitiesAttributesDto =
        entitiesAttributesMapper.entitiesAttributesToEntitiesAttributesDto(entitiesAttributes);
  ...
  public List<EntitiesAttributesDto> getAll() {
    return entitiesAttributesRepo.findAll().stream()
        .map(entitiesAttributesMapper::entitiesAttributesToEntitiesAttributesDto)
        .toList();
  }
  ...
  public EntitiesAttributesDto update(EntitiesAttributesUpdateDto entitiesAttributesUpdateDto) {
    ...
    EntitiesAttributes entitiesAttributes = findById(id);
    log.info(
        "entitiesAttributes with id: {} exists and successfully retrieved from the database", id);
    ...
    entitiesAttributesMapper.updateEntitiesAttributes(
        entitiesAttributesUpdateDto, entitiesAttributes);
    ...
    var response =
        entitiesAttributesMapper.entitiesAttributesToEntitiesAttributesDto(
            updatedEntitiesAttributes);
